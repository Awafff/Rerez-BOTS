...
`
        ...
        break
      case "allmenu": {
        if (!isRegistered) return rezReply(mess.regis)
        await load(m);
...
Ke @${u.split`@`[0]} Bang @${pushname}`)
      ...
      case 'sc': case 'sourcode': case 'secript': case 'scbot': {
        await RezzHost.sendMessage(m.chat, { react: { text: "⏳", key: m.key, } })
        let img = "https://telegra.ph/file/7297aef280592b9fdaad0.jpg"
        ...
        let msg = generateWAMessageFromContent(
          ...
          viewOnceMessage: {
            message: {
              interactiveMessage: {
                body: {
                  text: (`*SCRIPT ALWAYS XYREZZ OFFICIAL PROJEK FREE*`)
                },
                carouselMessage: {
                  cards: [{
                    header: {
                    ...
                    body: {
                      text: `*Hii Kak ${pushname}\n
*Hari : ${hariini}*
*Tanggal : ${tanggal2}*
*Jam : ${time}*

*BRIKUT ADALAH SCRIPT ALWAYS XYREZZ*
*[ VERSION 1.0 ]*` },
                    nativeFlowMessage: {
                      buttons: [{
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"GET SC V 1.0","url":"https://www.mediafire.com/file/eeq25dtyu4izz7q/Project+Rerez+V+10.0.0.zip/file","merchant_url":"https://www.google.com"}`
                      }, {
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"SUMBER SC","url":"https://whatsapp.com/channel/0029VacxTsC8F2p5dshCmq3r","merchant_url":"https://www.google.com"}`
                      }, {
                        "name": "cta_url",
                        "buttonParamsJson": "{\"display_text\":\"👥 SUMBER 2\",\"url\":\"https://whatsapp.com/channel/0029VaofHDeI7BeLcrFY9744\",\"merchant_url\":\"https://whatsapp.com/channel/0029VaofHDeI7BeLcrFY9744\"}"
                      },],
                    },
                  }, {
                    header: {
...
*[ VERSION 2.0 ]*` },
                    nativeFlowMessage: {
                      buttons: [{
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"GET SC V 2.0","url":"https://www.mediafire.com/file/9v3mo3wr8zlmppn/Sc+cpanel+by+Rerez+v+1.0.0.zip/file","merchant_url":"https://www.google.com"}`
                      }, {
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"SUMBER SC","url":"https://whatsapp.com/channel/0029VacxTsC8F2p5dshCmq3r","merchant_url":"https://www.google.com"}`
                      }, {
...
*[ VERSION 3.0 ]*` },
                    nativeFlowMessage: {
                      buttons: [{
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"GET SC V 3.0","url":"https://www.mediafire.com/file/ufwls561gezdjcr/Cpanel+v3+by+Rerez.zip/file","merchant_url":"https://www.google.com"}`
                      }, {
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"SUMBER SC","url":"https://whatsapp.com/channel/0029VacxTsC8F2p5dshCmq3r","merchant_url":"https://www.google.com"}`
                      }, {
...
*[ VERSION 4.0 ]*` },
                    nativeFlowMessage: {
                      buttons: [{
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"GET SC V 4.0","url":"https://www.mediafire.com/file/1hj0rkzqtemei0l/Project+Cpanel+V+4.0.0+Rerez.zip/file","merchant_url":"https://www.google.com"}`
                      }, {
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"SUMBER SC","url":"https://whatsapp.com/channel/0029VacxTsC8F2p5dshCmq3r","merchant_url":"https://www.google.com"}`
                      }, {
...
*[ VERSION 5.0 ]*` },
                    nativeFlowMessage: {
                      buttons: [{
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"GET SC V 5.0","url":"https://www.mediafire.com/file/tz00onl1atv4pgs/XYREZZ+PROJECT+V+5.0.0.zip/file","merchant_url":"https://www.google.com"}`
                      }, {
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"SUMBER SC","url":"https://whatsapp.com/channel/0029VacxTsC8F2p5dshCmq3r","merchant_url":"https://www.google.com"}`
                      }, {
...
*[ VERSION 6.0 ]*` },
                    nativeFlowMessage: {
                      buttons: [{
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"GET SC V 6.0","url":"https://www.mediafire.com/file/tz00onl1atv4pgs/XYREZZ+PROJECT+V+5.0.0.zip/file","merchant_url":"https://www.google.com"}`
                      }, {
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"SUMBER SC","url":"https://whatsapp.com/channel/0029VacxTsC8F2p5dshCmq3r","merchant_url":"https://www.google.com"}`
                      }, {
...
*[ VERSION 7.0 ]*` },
                    nativeFlowMessage: {
                      buttons: [{
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"GET SC V 7.0","url":"https://www.mediafire.com/file/zv2zmddojkogr81/ALWAYS+XYREZZ+V+7.0.zip/file","merchant_url":"https://www.google.com"}`
                      }, {
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"SUMBER SC","url":"https://whatsapp.com/channel/0029VacxTsC8F2p5dshCmq3r","merchant_url":"https://www.google.com"}`
                      }, {
...
*[ VERSION 8.0 ]*` },
                    nativeFlowMessage: {
                      buttons: [{
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"GET SC V 8.0","url":"https://www.mediafire.com/file/0ee8rc17t0u84an/ALWAYS+XYREZZ+V+8.0.zip/file","merchant_url":"https://www.google.com"}`
                      }, {
                        "name": "cta_url",
                        "buttonParamsJson": `{"display_text":"SUMBER SC","url":"https://whatsapp.com/channel/0029VacxTsC8F2p5dshCmq3r","merchant_url":"https://www.google.com"}`
                      }, {
